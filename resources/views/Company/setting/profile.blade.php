                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="companyForm" enctype="multipart/form-data" novalidate>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <img src="" class="img-thumb mt-2" id="logoPreview" alt="Logo Preview" style="width: 20%; height: auto; display: none;">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                ...
                                                {{-- @if(Session::get('login_type') == 'Company') --}}
                                                    <div class="accordion mb-3" id="menuPermissionsAccordion" style="display: none;">
                                                ...
                                                <div class="accordion mb-3" id="companyDetailsAccordion">
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingDetails">
                                                            <button class="accordion-button bg-primary text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDetails" aria-expanded="false" aria-controls="collapseDetails">
                                                                Additional Company Details
                                                            </button>
                                                        </h2>
                                                        <div id="collapseDetails" class="accordion-collapse collapse show" aria-labelledby="headingDetails" data-bs-parent="#companyDetailsAccordion">
                                                            <div class="accordion-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-1">
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    , success: function(response) {
                        ...
                        $('#country').val(response.country); cv
                        ...
                        // if (response.logo) {
                        //     var logoUrl = "{{ asset('assets/uploads/company') }}/" + response.logo;
