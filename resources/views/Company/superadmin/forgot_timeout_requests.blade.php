...
<!-- jQuery (needed for custom JS if not using Bootstrap's native) -->
...
<body>
                    ...
                    <div class="col-xxl-12 col-xl-12">
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="card-body">
                                             <h3 class="mb-4 text-capitalize">Forget Timeout Request</h3>
                                             @if(session('success'))
    ...
    @endif
                                    <div class="row">
                                          <table id="rawdata" class="table table-bordered menu-submenu-data" style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    <th style="width:1%;">#</th>
